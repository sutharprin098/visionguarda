...
<head>
    ...
    <meta name="description" content="Comprehensive Light Theme Architecture Overview for CamAI Enterprise CCTV AI Platform covering Web SaaS Portal, Desktop Client, Mobile App, and AXIS ACAP Native Edge Application with full UI screenshots.">
...
<body>
    ...
    <main class="container">
        ...
        <header class="hero">
            ...
            <p class="hero-desc">
                An end-to-end breakdown of CamAI across all four enterprise branches: Web SaaS Portal, Desktop Client, Mobile Push App, and AXIS ACAP Native Edge Analytics with full UI screenshots.
            </p>
        </header>
        ...
        <div class="branch-grid">
            ...
            <div class="branch-card acap" onclick="switchTab('acap')">
                <div class="branch-card-header">
                    ...
                    <div>
                        <div class="branch-title">AXIS ACAP Native</div>
                        <div class="branch-subtitle">ACAP/</div>
                    </div>
                </div>
                <div class="branch-desc">Hardware native edge C++ application for AXIS network cameras with ARTPEC-8 DLPU acceleration & VDO zero-copy.</div>
                <div class="branch-tags">
...
def connect_mobile_phone_stream(phone_ip="192.168.29.24", port=8080):
    ...
    return stream_url</div>
        ...
        <!-- Detail Panel 4: AXIS ACAP Native Application -->
        <div id="panel-acap" class="panel">
            <div class="panel-title-bar">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"/></svg>
                <h2 class="panel-title">AXIS ACAP Native Edge Application (`ACAP/`)</h2>
            </div>
            <div class="panel-grid">
                <div>
                    <p class="branch-desc">
                        A C/C++ native application compiled for AXIS network cameras (ARTPEC-8 / ARTPEC-7). Runs 100% on-device AI analytics with zero cloud latency and full ONVIF compliance.
                    </p>
                    <ul class="feature-list">
                        <li class="feature-item">
                            <svg class="check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                            <div><strong>AXIS VDO API (`vdo-stream.h`):</strong> Zero-copy NV12 frame buffer acquisition directly from camera hardware ISP.</div>
                        </li>
                        <li class="feature-item">
                            <svg class="check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                            <div><strong>AXIS Larod API (`larod.h`):</strong> NPU hardware acceleration for YOLOX-Tiny ONNX models with 8-bit quantization.</div>
                        </li>
                        <li class="feature-item">
                            <svg class="check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                            <div><strong>AXIS axevent & axoverlay:</strong> Native ONVIF XML event publishing and hardware stream bounding box rendering.</div>
                        </li>
                        <li class="feature-item">
                            <svg class="check-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                ...
                <table class="matrix-table" id="matrixTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span style="color: var(--accent-emerald); font-weight: 700;">✓ AXIS VDO Zero-Copy</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><span style="color: var(--accent-emerald); font-weight: 700;">✓ AXIS axevent (ONVIF)</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><span style="color: var(--accent-emerald); font-weight: 700;">✓ AXIS axoverlay (Hardware)</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><span style="color: var(--accent-emerald); font-weight: 700;">✓ AXIS axparameter (VAPIX)</span></td>
                        </tr>
                        <tr>
...
print("Light Theme overview pages generated successfully in all target paths!")

...
<head>
    ...
    <meta name="description" content="Comprehensive Web Application Architecture Overview for CamAI Enterprise CCTV AI Platform covering Web SaaS Portal, Desktop Client, Mobile App, and ACAP Native Edge Application with full UI screenshots and smooth scrolling.">
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="#desktop-client" class="nav-btn">
            ...
            <a href="#mobile-app" class="nav-btn">
            ...
            <a href="#acap-edge" class="nav-btn">
            ...
            <a href="#matrix" class="nav-btn primary">
    ...
    <main class="container">
        ...
        <header class="hero">
            ...
            <p class="hero-desc">
                An end-to-end breakdown of CamAI's four core pillars: Cloud SaaS Management, Windows Desktop Client, Mobile Push App, and ACAP Native Edge Analytics with full UI screenshots.
            </p>
            <div class="hero-actions">
                <a href="#tree" class="nav-btn primary">Explore Architecture Tree</a>
                <a href="#matrix" class="nav-btn">View Feature Matrix</a>
            </div>
        </header>
...
void CamAIEngine::process_loop() {
    while (is_running_) {
        ...
        <section id="matrix" class="section-block">
            <div class="pillar-header">
                <div class="pillar-title-group">
                    <div class="pillar-icon-wrapper" style="background:#e0e7ff; color:var(--accent-indigo);">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    </div>
                    <div>
                        <h2 class="pillar-title">A-to-Z Complete Feature Matrix</h2>
                        <div class="pillar-path">End-to-End System Capability Comparison</div>
                    </div>
                </div>
...
print("Full webapp overview generated cleanly!")

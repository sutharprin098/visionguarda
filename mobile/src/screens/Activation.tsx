      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 flex items-center justify-center gap-3">
          ...
          <div className="flex flex-col text-left">
            <span className="font-bold text-xl tracking-tight text-slate-900">CamAI Mobile Security</span>
            <span className="text-[10px] font-semibold tracking-wider text-sky-600 uppercase">Mobile Node</span>
          </div>
        </div>

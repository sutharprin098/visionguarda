...
export default function FloorPlanView({ bundle, healthInfo, onSelectCamera }: FloorPlanViewProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full md:h-[calc(100vh-80px)] gap-3 md:gap-6">
      {/* Sidebar / Camera Selector */}
      <div className="flex w-full md:w-64 shrink-0 flex-col gap-2 md:gap-3 rounded-lg border border-line bg-surface-1 p-3 md:p-4 max-h-48 md:max-h-none overflow-y-auto">
      ...
      {/* Main Map / 3D Board */}
      <div className="flex-1 flex flex-col gap-3 md:gap-4 min-h-[420px] md:min-h-0 w-full">
        {/* Header with 3D vs 2D Toggle Switch */}
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-line bg-surface-1 px-3 md:px-4 py-2.5 md:py-3">

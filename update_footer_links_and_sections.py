...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer-links a { color: #94a3b8; text-decoration: none; transition: color 0.2s; font-size: 0.85rem; }
...
<body>
    ...
    <section class="hero-section" id="overview">
        <div class="container hero-grid">
            ...
            <div>
                <!-- Native SVG Live Architecture Diagram -->
    ...
    <!-- 06. CORE AI ENGINE -->
    <section class="section-padding" id="ai-engine">
        <div class="container">
            <div class="section-header">
                <span class="section-badge">INTELLIGENCE LAYER</span>
                <h2 class="section-title">The CamAI Core AI Engine Pipeline</h2>
                <p class="section-desc">Real-time frame ingestion, hardware-accelerated tensor inference, Kalman filter tracking, and contextual rule evaluation.</p>
            </div>
            <div class="pipeline-flow">
                <div class="pipeline-node" onclick="alert('FRAME: NV12/YUV Video Frame Capture from Camera ISP');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 01</div>
                    <div style="font-weight:800; font-size:0.9rem;">FRAME</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('PREPROCESS: Aspect Normalization, Resize & Batch Pre-filtering');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 02</div>
                    <div style="font-weight:800; font-size:0.9rem;">PREPROCESS</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('INFERENCE: YOLOX-Tiny ONNX / OpenVINO / Larod NPU Execution');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 03</div>
                    <div style="font-weight:800; font-size:0.9rem;">INFERENCE</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('DETECTION: Bounding Box NMS Filtering & Class Probability Thresholding');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 04</div>
                    <div style="font-weight:800; font-size:0.9rem;">DETECTION</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('TRACKING: C++ ByteTrack Kalman Filter Motion State Assignment');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 05</div>
                    <div style="font-weight:800; font-size:0.9rem;">TRACKING</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('ANALYTICS: Polygonal ROI Intrusion & Line Crossing Vector Math');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 06</div>
                    <div style="font-weight:800; font-size:0.9rem;">ANALYTICS</div>
                </div>
                <div style="color:var(--text-muted); font-weight:bold;">→</div>
                <div class="pipeline-node" onclick="alert('EVENT ENGINE: Realtime Alert Webhook & ONVIF axevent Broadcasting');">
                    <div class="font-mono" style="font-size:0.7rem; color:var(--text-muted);">STEP 07</div>
                    <div style="font-weight:800; font-size:0.9rem;">EVENT ENGINE</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-padding section-dark" id="modules">
        <div class="container">
            <div class="section-header">
                <span class="section-badge">7 SPECIALIZED AI MODULES</span>
            ...
            <div class="modules-grid">
                <div class="module-card" id="module-security">
                ...
                <div class="module-card" id="module-traffic">
                ...
                <div class="module-card" id="module-ppe">
                ...
                <div class="module-card" id="module-retail">
                ...
                <div class="module-card" id="module-smartcity">
                ...
                <div class="module-card" id="module-micromotion">
                ...
                <div class="module-card" id="module-custom" style="grid-column: span 1;">
    ...
    <section class="section-padding" id="surfaces">
        <div class="container">
            ...
            <div style="margin-bottom:3rem;" id="surface-web">
            ...
            <div style="margin-bottom:3rem;" id="surface-desktop">
                <div style="margin-bottom:1rem;">
                ...
                <div style="display:flex; justify-content:center;">
                    <div style="width:280px; background:#0f172a; border:4px solid #334155; border-radius:32px; padding:12px; box-shadow:var(--shadow-lg);">
                        ...
                        <div style="background:#ffffff; border-radius:20px; padding:12px; height:420px; display:flex; flex-direction:column; justify-space-between;">
                            ...
                            <div style="display:flex; justify-space-around; border-top:1px solid var(--border-light); padding-top:8px; font-size:0.65rem; font-weight:700; color:var(--text-muted);">
                                <span>Alerts</span>
    ...
    <!-- 17. UNIFIED ARCHITECTURE & CAMERA TO INTELLIGENCE FLOW -->
    <section class="section-padding section-dark" id="architecture">
        <div class="container">
            <div class="section-header">
                <span class="section-badge">6-LAYER STACK</span>
                <h2 class="section-title">Camera-to-Intelligence Architectural Stack</h2>
                <p class="section-desc">Full horizontal data ingestion and event processing stack from raw RTSP video streams to operational operator actions.</p>
            </div>
            <div class="statement-grid">
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <div class="font-mono" style="font-size:0.75rem; color:#60a5fa; font-weight:700; margin-bottom:4px;">LAYER 01 / SOURCES</div>
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px;">IP Cameras & RTSP</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">H.264/H.265 video input decoding via OpenCV and ONVIF device discovery.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <div class="font-mono" style="font-size:0.75rem; color:#60a5fa; font-weight:700; margin-bottom:4px;">LAYER 02 / PIPELINE</div>
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px;">Capture & Preprocess</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Zero-copy frame buffer acquisition, resolution scaling, and frame selection.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <div class="font-mono" style="font-size:0.75rem; color:#60a5fa; font-weight:700; margin-bottom:4px;">LAYER 03 / AI CORE</div>
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px;">Inference & Tracking</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">YOLOX ONNX runtime, OpenVINO, Larod NPU, and ByteTrack Kalman filters.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <div class="font-mono" style="font-size:0.75rem; color:#60a5fa; font-weight:700; margin-bottom:4px;">LAYER 04 / ANALYTICS</div>
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px;">ROI & Rule Engine</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Polygon intrusion math, line crossing vectors, speed, and occupancy rules.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-padding" id="performance">
        <div class="container">
            <div class="section-header">
                <span class="section-badge">BENCHMARK DATA</span>
                <h2 class="section-title">Engine Performance & Latency Telemetry</h2>
                <p class="section-desc">Empirical runtime benchmarks measured across CPU, OpenVINO GPU, and Larod NPU edge runtimes.</p>
            </div>
            <div class="statement-grid">
                <div class="statement-card">
                    <div class="font-mono" style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">INFERENCE LATENCY</div>
                    <div style="font-size:2rem; font-weight:900; color:var(--accent-emerald);">11.2 ms</div>
                    <p style="font-size:0.8rem; color:var(--text-secondary);">Sub-15ms NPU 8-bit YOLOX model execution.</p>
                </div>
                <div class="statement-card">
                    <div class="font-mono" style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">DESKTOP GRID FPS</div>
                    <div style="font-size:2rem; font-weight:900; color:var(--accent-indigo);">38.4 FPS</div>
                    <p style="font-size:0.8rem; color:var(--text-secondary);">Multi-stream preview grid throughput.</p>
                </div>
                <div class="statement-card">
                    <div class="font-mono" style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">ID SWITCH RATE</div>
                    <div style="font-size:2rem; font-weight:900; color:var(--accent-blue);">0 / 10K</div>
                    <p style="font-size:0.8rem; color:var(--text-secondary);">Zero ID switches using ByteTrack Kalman matching.</p>
                </div>
                <div class="statement-card">
                    <div class="statement-card" style="padding:0; border:none; box-shadow:none;">
                    <div class="font-mono" style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">DROPPED FRAMES</div>
                    <div style="font-size:2rem; font-weight:900; color:var(--accent-emerald);">0.00 %</div>
                    <p style="font-size:0.8rem; color:var(--text-secondary);">ResourceGovernor DROP_OLDEST queue protection.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- 26. SECURITY & RBAC PERMISSIONS -->
    <section class="section-padding section-dark" id="security">
        <div class="container">
            <div class="section-header">
                <span class="section-badge">ENTERPRISE SECURITY</span>
                <h2 class="section-title">Built for High-Security Environments</h2>
                <p class="section-desc">Encrypted machine key bindings, PostgreSQL Row Level Security (RLS), and 4-tier granular role permissions.</p>
            </div>
            <div class="statement-grid">
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px; color:#60a5fa;">PostgreSQL RLS Privacy</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Multi-tenant database privacy enforcing organization boundaries at the SQL row level.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px; color:#60a5fa;">DPAPI Hardware Locks</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Windows DPAPI tokens bound to MachineGUID, CPU ID, and TPM serial numbers.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px; color:#60a5fa;">Granular RBAC Roles</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Org Admin, Security Operator, Site Manager, and Compliance Auditor roles.</p>
                </div>
                <div class="statement-card" style="background:#111827; border-color:#1f2937; color:#fff;">
                    <h4 style="font-weight:800; font-size:1rem; margin-bottom:4px; color:#60a5fa;">Tamper-Proof Audit Trail</h4>
                    <p style="font-size:0.825rem; color:#94a3b8;">Immutable telemetry history tracking all login, zone edit, and triage events.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- 34. TECHNICAL DOCUMENTATION SECTION -->
    <section class="section-padding" id="documentation">
        <div class="container" style="text-align:center; max-width:800px;">
            <span class="section-badge">DOCUMENTATION</span>
            <h2 class="section-title">Technical Overview & System Manuals</h2>
            <p class="section-desc" style="margin-bottom:2rem;">Explore complete implementation guides, API schemas, ACAP migration docs, and C++ source code references.</p>
            <a href="https://github.com/sutharprin098/visionguarda" target="_blank" class="btn-primary" style="padding:12px 28px; font-size:0.95rem;">View Technical Overview</a>
        </div>
    </section>
    ...
    <section class="section-padding section-dark" id="contact" style="text-align:center;">
        <div class="container" style="max-width:720px;">
            ...
            <div style="display:flex; justify-content:center; gap:12px; flex-wrap:wrap;">
                <a href="#overview" class="btn-primary" style="padding:12px 28px; font-size:0.95rem;">Explore CamAI</a>
                <a href="#contact" class="btn-outline" style="background:transparent; color:#fff; border-color:#334155; padding:12px 28px; font-size:0.95rem;">Request Demo</a>
            </div>
    ...
    <!-- 37. FOOTER WITH ALL 7 MODULES AND COMPLETE FUNCTIONAL LINKS -->
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <ul class="footer-links">
                        <li><a href="#surface-web">Web Portal</a></li>
                        <li><a href="#surface-desktop">Desktop Client</a></li>
                        <li><a href="#surface-mobile">Mobile App</a></li>
                        <li><a href="#acap-edge">Edge / ACAP</a></li>
                    </ul>
                </div>
                <div>
                    <div class="footer-title">All 7 AI Modules</div>
                    <ul class="footer-links">
                        <li><a href="#module-security">01 Security & Perimeter</a></li>
                        <li><a href="#module-traffic">02 Traffic & Vehicle</a></li>
                        <li><a href="#module-ppe">03 Factory PPE Safety</a></li>
                        <li><a href="#module-retail">04 Retail Footfall & Dwell</a></li>
                        <li><a href="#module-smartcity">05 Smart City Crowding</a></li>
                        <li><a href="#module-micromotion">06 Micro Motion Anomaly</a></li>
                        <li><a href="#module-custom">07 Custom Trigger Engine</a></li>
                    </ul>
                </div>
                <div>
                    <div class="footer-title">Enterprise</div>
                    <ul class="footer-links">
                        <li><a href="#security">Security & RLS</a></li>

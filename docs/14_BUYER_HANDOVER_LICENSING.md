# CamAI Enterprise - Buyer Handover & Licensing Documentation

---

> **Classification**: Enterprise IP Transfer & Handover Package  
> **Document Reference**: `DOC-HANDOVER-14`

---

## 1. Source Code Transfer Checklist

This complete, production-ready source code handover package includes full intellectual property (IP) transfer rights:

- [x] **Complete Core Backend Engine**: Python 3.11 FastAPI server, multi-backend AI runner (`backend.py`), pipeline thread orchestrator (`pipeline.py`), rule engine (`analytics.py`), and incident recorder (`recorder.py`).
...
## 2. Licensing & Commercial Terms

- **License Type**: Perpetual Enterprise Source Code License & IP Ownership Transfer.
- **Third-Party Open Source Compliance**:
  - OpenCV (Apache 2.0)
  - PyTorch / ONNX Runtime (MIT)
  - OpenVINO Toolkit (Apache 2.0)
  - React & Electron (MIT)
  - FastAPI (MIT)

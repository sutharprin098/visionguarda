...
MJPEG_MAX_FPS = float(os.getenv("CAMAI_MJPEG_MAX_FPS", "40"))
...
# Minimum primary-detector confidence required to trigger action pipelines (alerts, ANPR)
VEHICLE_ACTION_MIN_CONFIDENCE = _env_float("CAMAI_VEHICLE_ACTION_MIN_CONFIDENCE", 0.5)

# Minimum primary-detector person confidence required to qualify as an active rider
...
# Periodic sweep interval (s) at full tile density to detect small objects in low-motion scenes

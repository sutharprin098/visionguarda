...
ANPR_THRESHOLD = _env_float("CAMAI_ANPR_THRESHOLD", 0.02)
ANPR_NMS = _env_float("CAMAI_ANPR_NMS", 0.3)
ANPR_ASPECT_MIN = _env_float("CAMAI_ANPR_ASPECT_MIN", 1.0)
ANPR_ASPECT_MAX = _env_float("CAMAI_ANPR_ASPECT_MAX", 7.5)
ANPR_MIN_PLATE_W = _env_int("CAMAI_ANPR_MIN_PLATE_W", 12)
ANPR_UPSCALE_TO_W = _env_int("CAMAI_ANPR_UPSCALE_TO_W", 320)
ANPR_PLATE_PAD_FRAC = _env_float("CAMAI_ANPR_PLATE_PAD_FRAC", 0.08)
ANPR_MAX_AREA_FRAC = _env_float("CAMAI_ANPR_MAX_AREA_FRAC", 0.45)
...
ANPR_OCR_MIN_LEN = _env_int("CAMAI_ANPR_OCR_MIN_LEN", 3)
ANPR_COUNTRY = os.getenv("CAMAI_ANPR_COUNTRY", "IN")
ANPR_OCR_MIN_CONF = _env_float("CAMAI_ANPR_OCR_MIN_CONF", 0.15)
ANPR_REQUIRE_VALID_FORMAT = _env_bool("CAMAI_ANPR_REQUIRE_VALID_FORMAT", False)

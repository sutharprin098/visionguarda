...
NON_COCO_PRODUCIBLE = {"face", "helmet", "no_helmet", "number_plate", "custom_object", "micro_motion", "vest", "no_vest", "gloves", "shoes", "mask", "goggles", "fire", "smoke", "forklift", "cell phone"}

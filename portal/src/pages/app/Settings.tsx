  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card space-y-2 p-4 text-sm text-ink-2">
        <div className="flex justify-between"><span className="text-ink-3">Portal version</span><span className="font-semibold text-ink-1">v1.1.0</span></div>
        <div className="flex justify-between"><span className="text-ink-3">Desktop client installer</span><span className="font-semibold text-accent">v1.1.0 (Win64)</span></div>

            ...
            <nav className="flex flex-col gap-3">
              ...
              <div className="mt-3 flex flex-col gap-2 border-t border-slate-200 pt-3">
                ...
                >
                  ...
                  Download Desktop Setup v1.2.0 (.exe)
                </a>
                ...
                >
                  ...
                  Download Mobile App v1.0.3 (.apk)
                </a>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs font-medium text-slate-600 font-mono">
                <li>
                  <a href="/downloads/CamAI-Desktop-Setup-1.2.0.exe" download="CamAI-Desktop-Setup-1.2.0.exe" className="text-sky-600 font-bold hover:underline flex items-center gap-1">
                    <Download size={11} /> Desktop v1.2.0 (.exe)
                  </a>
                </li>
                <li>
                  <a href="/downloads/CamAI-Mobile.apk" download="CamAI-Mobile-v1.0.3.apk" className="text-slate-700 font-bold hover:underline flex items-center gap-1">
                    <Download size={11} /> Mobile App v1.0.3 (.apk)
                  </a>
                </li>
              </ul>
            </div>

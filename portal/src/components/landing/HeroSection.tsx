    ...
    <section className="relative overflow-hidden pt-8 pb-16 sm:pt-16 sm:pb-24 bg-gradient-to-b from-sky-100/70 via-slate-50 to-blue-50/50 text-slate-900">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-sky-300/80 bg-white/80 backdrop-blur-md text-sky-800 text-xs font-bold uppercase tracking-wider shadow-md shadow-sky-500/10">
            ...
            <span className="text-rose-600 font-extrabold flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-rose-500 animate-pulse" /> DESKTOP V1.1.0 &amp; MOBILE V1.0.2
            </span>
            <span className="text-slate-300">•</span>
            <span className="text-sky-600 font-extrabold">DIGITAL TWIN &amp; SCENE AI</span>
          </div>
        </motion.div>
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <a
              href="/downloads/CamAI-Desktop-Setup-1.1.0.exe"
              download="CamAI-Desktop-Setup-1.1.0.exe"
            ...
            >
              <Download size={18} />
              <span>Desktop Setup (v1.1.0 .exe)</span>
            </a>
          ...
          >
            <span className="flex items-center gap-1.5">
              <CheckCircle2 size={15} className="text-sky-600" /> DIGITAL TWIN 3D VIEW
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 size={15} className="text-sky-600" /> AUTO SCENE DETECTOR
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle2 size={15} className="text-sky-600" /> 24/7 NVR RECORDING
            </span>
            <span className="flex items-center gap-1.5">

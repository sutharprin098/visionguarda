...
export default function LiveTelemetryDashboard() {
  ...
  return (
    <section id="live-system" className="py-24 relative overflow-hidden bg-slate-50 border-b border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="architectural-card p-5 bg-white">
            ...
            <div className="text-[11px] font-mono text-slate-500 mt-2 pt-2 border-t border-slate-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="architectural-card p-6 bg-white flex flex-col justify-between">
            <div>
                    ...
                    <div key={a.id} className="py-3 flex items-center justify-between text-xs gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] font-mono text-slate-500">{a.kind.replaceAll("_", " ")}</div>
                        </div>
                      </div>
